...
function addStudent(){
    ...
    if(nameValue=='' || emailValue=='' || ageValue=='' || rollNo =='' || degreeValue==""){
    ...
    students.forEach((student)=>{
        ...
        keys.forEach((key)=>{
            if(key=='ID'){
                ...
                rollno.innerHTML = student[key];
            }
            else
            degree.innerHTML = `<div class='degree'><div>${student[key]}</div>
            <div class="icons">
            <a onClick="edit(${student['ID']})" class='fa'><i class="fa-regular fa-pen-to-square"></i></a>
            <a onClick="del(${student['ID']})" class='fa'><i class="fa-solid fa-trash"></i></a>
            </div>
            </div> `;
